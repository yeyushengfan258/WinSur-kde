...
install() {
  ...
  [[ -d ${SCHEMES_DIR}/McConceptX.colors ]] && rm -r ${SCHEMES_DIR}/McConceptX.colors
  ...
  [[ ${color} == '' ]] && \
  cp -ur ${SRC_DIR}/color-schemes/McConceptX.colors                                    ${SCHEMES_DIR} && \
  cp -ur ${SRC_DIR}/color-schemes/McConceptX.colors                                    ${PLASMA_DIR}/${name}/colors

  [[ ${color} == '-light' ]] && \
  cp -ur ${SRC_DIR}/color-schemes/McConceptX.colors                               ${SCHEMES_DIR}
}

echo "Installing 'McConceptX kde themes'..."
